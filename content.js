(function () {
  if (!location.hostname.endsWith("cv-library.co.uk")) return;
  if (document.getElementById("cvlibrary-copy-ui")) return;

  const TARGET_SELECTOR = ".job__main.job-card.js-show-cta";
  ...
  uiWrapper.id = "cvlibrary-copy-ui";
  ...
  const sendBtn = makeBtn("Send", "#005da4");
  ...
  new MutationObserver(() => {
    if (!document.getElementById("cvlibrary-copy-ui")) {
      document.body.appendChild(uiWrapper);
    }
